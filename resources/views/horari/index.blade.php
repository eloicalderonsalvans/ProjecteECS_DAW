...
@section('styles')
    ...
    <style>
        /* Estils generals de FullCalendar */
        .fc {
        ...
        /* Alçada fixa per a totes les cel·les */
        ...
        /* Amaguem el puntet de color */
        .fc-daygrid-event-dot {
            display: none !important;
        }

        /* Separació del número del dia */
        .fc-daygrid-day-top {
            padding: 8px;
            font-weight: 600;
            color: #64748b;
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-200/60 mb-8">
            ...
            <div class="flex flex-col items-center justify-center max-w-2xl mx-auto py-4">
                <div class="flex flex-col items-center gap-4 w-full">
                    <div
                        class="flex items-center gap-2 px-4 py-1.5 bg-indigo-50 text-indigo-700 rounded-full border border-indigo-100 shadow-sm animate-pulse">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                noEventsContent: 'No hi ha torns assignats',

                // --- FUNCIONALITAT: ELIMINAR EN CLICAR ---
            ...
            userSelector.addEventListener('change', function () {
                ...
                calendar.addEventSource({
                    ...
                    failure: () => {
                        ...
                        alert('Error al carregar les dades de l\'usuari.');
                    }
                });
            });

            // Si hi ha un valor per defecte seleccionat al carregar (per exemple si tornem de crear)
