            ...
            <div class="mb-8 flex flex-col items-center">
                <div class="relative group mb-4">
                    <div id="avatar-placeholder"
                        style="width: 112px; height: 112px; border-radius: 50%; background: linear-gradient(135deg, #f8fafc, #e2e8f0); display: flex; align-items: center; justify-content: center; color: #94a3b8; shadow: 0 10px 15px -3px rgba(0,0,0,0.1); border: 4px solid #f1f5f9; flex-shrink: 0;">
                    ...
                    <img id="avatar-preview" src="" alt="Previsualització"
                        style="width: 112px; height: 112px; border-radius: 50%; object-fit: cover; border: 4px solid #dbeafe; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1); flex-shrink: 0; display: none;">
                ...
                <p class="text-xs text-gray-400 font-medium">Fes clic per afegir una foto de perfil</p>
            </div>
